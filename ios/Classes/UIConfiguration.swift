...
struct UIConfiguration {
    ...
    init(from arguments: [String: Any]?) {
        // Text defaults
        self.navigationTitle = arguments?["navigationTitle"] as? String ?? UIConfiguration.default.navigationTitle
        self.saveButtonText = arguments?["saveButtonText"] as? String ?? UIConfiguration.default.saveButtonText
        self.appsCountText = arguments?["appsCountText"] as? String ?? UIConfiguration.default.appsCountText
        self.websitesCountText = arguments?["websitesCountText"] as? String ?? UIConfiguration.default.websitesCountText
        self.categoriesCountText = arguments?["categoriesCountText"] as? String ?? UIConfiguration.default.categoriesCountText
        
        // Color configuration
        self.saveButtonColor = Self.colorFromHex(arguments?["saveButtonColor"] as? String) ?? UIConfiguration.default.saveButtonColor
        self.saveButtonTextColor = Self.colorFromHex(arguments?["saveButtonTextColor"] as? String) ?? UIConfiguration.default.saveButtonTextColor
        self.countTextColor = Self.colorFromHex(arguments?["countTextColor"] as? String) ?? UIConfiguration.default.countTextColor
        self.navigationTintColor = Self.colorFromHex(arguments?["navigationTintColor"] as? String)
        self.darkTextColor = Self.colorFromHex(arguments?["darkTextColor"] as? String) ?? UIConfiguration.default.darkTextColor
        
        // Font configuration (simplified - could be expanded)
        let saveButtonFontSize = arguments?["saveButtonFontSize"] as? Double
        self.saveButtonFont = saveButtonFontSize != nil ? .system(size: CGFloat(saveButtonFontSize!)) : UIConfiguration.default.saveButtonFont
        
        let countTextFontSize = arguments?["countTextFontSize"] as? Double
        self.countTextFont = countTextFontSize != nil ? .system(size: CGFloat(countTextFontSize!)) : UIConfiguration.default.countTextFont
        
        let navigationTitleFontSize = arguments?["navigationTitleFontSize"] as? Double
        self.navigationTitleFont = navigationTitleFontSize != nil ? .system(size: CGFloat(navigationTitleFontSize!)) : nil
    }
